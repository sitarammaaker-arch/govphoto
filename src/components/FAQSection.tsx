...
const faqs = [
  ...
  { q: 'How to reduce photo size to 20KB online?',
    a: 'Upload your photo on SignResizer, select the "SSC Photo" preset (20–50KB), and click Resize. The tool automatically compresses your photo to the required size while maintaining quality. You can then download the resized JPG instantly.' },
