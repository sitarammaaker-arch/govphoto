...
const faqs = [
  ...
  { q: 'How to reduce photo size to 20KB online?',
    a: 'Upload your photo on Sign Resizer, select the "SSC Photo" preset (20–50KB), and click Resize. The tool automatically compresses your photo to the required size while maintaining quality. You can then download the resized JPG instantly.' },
  ...
  { q: 'Is this tool free to use?',
    a: 'Yes, Sign Resizer is completely free to use. No registration, login, or payment required. Your images are processed securely in memory and are never stored on our servers.' },
